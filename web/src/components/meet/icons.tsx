...
export function CamIcon({ size }: P) {
  return (
    <svg {...b(size)}>
...
export function CamOffIcon({ size }: P) {
  return (
    <svg {...b(size)}>
      <line x1="2" y1="2" x2="22" y2="22" />
...
export function ScreenIcon({ size }: P) {
  return (
    <svg {...b(size)}>
...
export function CaptionsIcon({ size }: P) {
  return (
    <svg {...b(size)}>
...
export function PeopleIcon({ size }: P) {
  return (
    <svg {...b(size)}>
...
export function LeaveIcon({ size }: P) {
  return (
    <svg {...b(size)}>
...
export function SpotlightIcon({ size }: P) {
  return (
    <svg {...b(size)}>
...
export function ChatIcon({ size }: P) {
  return (
    <svg {...b(size)}>
